...
def main():
    pygame.init()
    # Размеры берутся из paint_engine (1200x950), чтобы всё влезло
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    pygame.display.set_caption("Paint Pro 1200x950")
    ...
    while True:
        ...
        # Палитра (palette_y теперь 460, чтобы не было наложений)
        palette_y = 460 
